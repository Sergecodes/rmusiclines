...
from accounts.decorators import rate_limit
from accounts.exceptions import ImmediateHttpResponse
from accounts.utils import get_form_class, get_request_param
...
class ConfirmEmailView(TemplateResponseMixin, LogoutFunctionalityMixin, View):
    ...
    def post(self, *args, **kwargs):
        ...
        if app_settings.LOGIN_ON_EMAIL_CONFIRMATION:
            ...
            if resp is not None:
                return resp
        # Don't -- accounts doesn't touch is_active so that sys admin can
