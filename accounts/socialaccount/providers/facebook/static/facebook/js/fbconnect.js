...
(function () {
  ...
  function setLocationHref (url) {
    if (typeof (url) === 'function') {
      ...
      // accounts.facebook.onLoginError et al directly.
      url()
    } else {
  ...
  var accounts = window.accounts = window.accounts || {}
  var fbSettings = JSON.parse(document.getElementById('accounts-facebook-settings').innerHTML)
  ...
  accounts.facebook.init(fbSettings)
})()
