...
from accounts.account.models import EmailAddress
from accounts.socialaccount.app_settings import QUERY_EMAIL
from accounts.socialaccount.providers.base import (
    AuthAction,
    AuthProcess,
    ProviderAccount,
)
from accounts.socialaccount.providers.oauth2.provider import OAuth2Provider
from accounts.utils import import_callable
...
class FacebookProvider(OAuth2Provider):
    ...
    def get_login_url(self, request, **kwargs):
        ...
        if method == "js_sdk":
            ...
            js = "accounts.facebook.login(%s, %s, %s, %s)" % (
                next,
                action,
                process,
                scope,
    ...
    def media_js(self, request):
        ...
        from accounts.socialaccount.models import SocialApp
