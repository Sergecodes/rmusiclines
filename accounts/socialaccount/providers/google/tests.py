...
from accounts.account import app_settings as account_settings
from accounts.account.adapter import get_adapter
from accounts.account.models import EmailAddress, EmailConfirmation
from accounts.account.signals import user_signed_up
from accounts.socialaccount.models import SocialAccount, SocialToken
from accounts.socialaccount.tests import OAuth2TestsMixin
from accounts.tests import MockedResponse, TestCase, patch
...
class GoogleTests(OAuth2TestsMixin, TestCase):
    ...
    def test_google_compelete_login_401(self):
        from accounts.socialaccount.providers.google.views import (
            GoogleOAuth2Adapter,
        )
        ...
        with patch(
            "accounts.socialaccount.providers.google.views.requests"
        ) as patched_requests:
