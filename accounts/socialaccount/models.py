...
from accounts.account.utils import get_next_redirect_url, setup_user_email
...
class SocialAccount(models.Model):
    user = models.ForeignKey(accounts.app_settings.USER_MODEL, on_delete=models.CASCADE)
    provider = models.CharField(
        verbose_name=_("provider"),
        max_length=30,
        choices=providers.registry.as_choices(),
